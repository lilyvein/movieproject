...
urlpatterns = [
    ...
    path('country_list/', views.CountryListView.as_view(), name='country_list'),  # Movie List View
    path('country_detail/<int:pk>', views.CountryDetailView.as_view(), name='country_detail'),  # Movie detail View
